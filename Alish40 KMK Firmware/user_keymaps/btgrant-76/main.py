...
keyboard.keymap = [
    ...
    # |------+------+------+------+------+------+------+------+------+------+------+------|
    # | Shift|   Z  |   X  |   C  |   V  |   B  |XXXXXX|   N  |   M  |   ,  |   .  | Enter|
    # |------+------+------+------+------+------+------+------+------+------+------+------|
    ...
    # `-----------------------------------------------------------------------------------'
    [
        KC.ESC,  KC.F1,    KC.F2,    KC.F3,    KC.F4,    KC.F5,    KC.F6,     KC.F7,   KC.F8,   KC.F9,    KC.F10,   KC.DEL,
    ...
    [
        ...
        KC.LSFT,  KC.UNDS, KC.PLUS, KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.PIPE, KC.BSLS, KC.LCBR, KC.RCBR, _______,
